...
function datediff(mode, startdate, enddate) {
    ...
    if (mode == "day") {
        ...
        diff = (enddate.getFullYear() - startdate.getFullYear()) * 12 + (enddate.getMonth() - startdate.getMonth());
    }
    else if (mode == "year") {
            ...
            switch (j) {
                ...
                case 4:
                    ...
                    if (DayBasisInterest == 0) {
                        ...
                        if (ExecStartDateRule = "1" && lastinterestdate.getDate()!=currentdate.getDate()) {
                            ...
                            if (lastinterestdate.getMonth() != currentdate.getMonth() && lastinterestdate.getDate() > currentdate.getDate()) {
                                tempDateDiff = 30 - (lastinterestdate.getDate() - currentdate.getDate());
                            }
                            ...
                            InterestAmount = Number(schedule[9][i - 1] * nominalrate * tempDateDiff / (100 * YearDay)).toFixed(precision);
                        }
                        /**************************************************************************************/
                        else {
                            //InterestAmount = Math.round(schedule[9][i - 1] * nominalrate * PrinciapalFrequency / 1200);
                    ...
                    */
                    ...
                    //console.log('Principal:' + PrinciapalDate + ' interest:' + InterestDate);
