<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="frmWaiting.aspx.vb" Inherits="frmWaiting" Title="Periodic Visit: Waiting Approval" %>
            ...
            <div class="col-md-12">
                <div class="card">
                    <h6 class="card-header">
                        Waiting for Approval <a href="frmDashboard.aspx"><i class="fa-solid fa-house-user fa-2x">
                        </i></a>
                    </h6>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div style="width: 100%; overflow: auto">
                                    <asp:GridView ID="grdWaitingList" CssClass="table" runat="server" AutoGenerateColumns="False"
                                        EmptyDataText="No Waiting List">
                                        <Columns>
                                            <asp:TemplateField HeaderText="View">
                                                <ItemTemplate>
                                                    <a href='<%# Eval("ReportID","frmApproval.aspx?ReportID={0}") %>' target="_blank"><i
