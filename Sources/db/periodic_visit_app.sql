...
-- exec spFindVisitReports 'a','01-Jun-2024','27-Jun-2024'
...
begin
	...
	) and r.IsSubmitted = 1 and r.SubmissionDate between @StartDate and DATEADD(DAY,1,@EndDate)
...
begin
	...
	Declare @MailBCC as nvarchar(50) Set @MailBCC = 'divit@meridianfinancebd.com';
	...
	begin
		...
		Select @MailFrom = @ApproverEmail
		Select @MailTo = @UserEmail
		set @MailBCC = 'faruk@meridianfinancebd.com'
	end
